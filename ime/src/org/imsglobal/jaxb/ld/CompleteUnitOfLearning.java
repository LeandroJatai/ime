...
/**
 * <p>Java class for complete-unit-of-learningType complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="complete-unit-of-learningType">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;choice>
 *         &lt;element ref="{http://www.imsglobal.org/xsd/imsld_v1p0}when-play-completed" maxOccurs="unbounded"/>
...
@XmlType(name = "complete-unit-of-learningType", propOrder = {
    "whenPlayCompletedList",
    "timeLimit",
    "whenPropertyValueIsSetList"
})
public class CompleteUnitOfLearning extends ImeObject
    implements Serializable
{

    private final static long serialVersionUID = 12345L;
    @XmlElement(name = "when-play-completed")
    protected List<WhenPlayCompleted> whenPlayCompletedList;
    ...
    /**
     * Gets the value of the whenPlayCompletedList property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the whenPlayCompletedList property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getWhenPlayCompletedList().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link WhenPlayCompleted }
     * 
     * 
     */
    public List<WhenPlayCompleted> getWhenPlayCompletedList() {
        if (whenPlayCompletedList == null) {
            whenPlayCompletedList = new ArrayList<WhenPlayCompleted>();
        }
        return this.whenPlayCompletedList;
    }
